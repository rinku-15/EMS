...
export const EmployeeCard = ({employee, onDelete, onEdit}) => {
  ...
  return (
    <div className='group relative card card-hover overflow-hidden'>
        ...
        <div className='absolute top-3 left-3 flex pag-2'>
            <span className='bg-white/90 backdrop-blur-sm px-2.5 py-1 text-xm font-semibold text-slate-600 rounded-lg shadow-sm'>{employee.department || "Remote"}</span>
