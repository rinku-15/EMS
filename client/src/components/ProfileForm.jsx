        ...
        <form onSubmit={handleSubmit} className='card p-5 sm:p-6 mb-6'>
            ...
            <div className='space-y-5'>
                ...
                <div>
                     ...
                     defaultValue={initialData.bio || ""} placeholder='Write a brief bio...' className={`resize-none ${initialData.isDeleted ? 'bg-slate-50 text-slate-400 cursor-not-allowed' : ""}`} />
                ...
                {initialData.isDeleted ? (
                    ...
                    <div className='p-4 bg-rose-50 border border-rose-200 rounded-xl text-center'>
                        ...
                        <p className='text-sm text-rose-500 mt-0.5'>You can no longer update your pro.file</p>
                        </div>
                        </div>

                ) : (
                    <div className='flex justify-end pt-2'>
                        <button type='submit' disabled={loading} className='btn-primary flex items-center gap-2 justify-centerw-full sm:w-auto'>
